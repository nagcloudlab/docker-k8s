...
# Update URLs to use Docker service names
PRODUCT_SERVICE_URL = os.getenv('PRODUCT_SERVICE_URL', 'http://product:5001/product/')
RECOMMENDATION_SERVICE_URL = os.getenv('RECOMMENDATION_SERVICE_URL', 'http://recommendation:5002/recommendation/')
REVIEW_SERVICE_URL = os.getenv('REVIEW_SERVICE_URL', 'http://review:5003/review/')
